        ...
        return <Container sx={{ height: "15vh" }}>
            ...
            <img src={logo} className="logo-small" alt="logo" />
                    ...
                    <Grid container item spacing={0} direction="row" alignItems="baseline" justifyContent="flex-end">
                        <Grid item sm={0} md={2} lg={2} xl={3} ><a href="default.asp"><h5>Skills & Tools</h5></a></Grid>
                        <Grid item sm={0} md={2} lg={2} xl={2} ><a href="news.asp"><h5>Projects</h5></a></Grid>
                        <Grid item sm={0} md={2} lg={2} xl={2} ><a href="contact.asp"><h5>Contact</h5></a></Grid>
                        <Grid item sm={2} md={2} lg={2} xl={2} >
                            <Fade bottom delay={500}>
                                <a href="about.asp"><Button variant="contained" className="btn bg-primary" ><h5>Hire Me!</h5></Button></a>
                            </Fade>
                        </Grid>
                    </Grid>
                </Grid>
